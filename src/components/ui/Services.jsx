                ...
                <section id="bottom">
                     ...
                     <div className="flex flex-col justify-center w-full p-10 items-center space-y-3">
                        <div className="inline-flex justify-center items-center w-full">
                            ...
                            <h1 className="text-4xl sm:text-6xl font-bold text-black">Basic service</h1>
                            <hr className="my-8 sm:w-64 h-px bg-gray-200 border-0 dark:bg-gray-700" />
                        </div>
                        <div className="flex flex-col max-w-[700px] text-black">
                            <p className="text-xl sm:text-2xl font-bold max-w-[700px]">
                        ...
                        <div className=" animate-bounce">
                            <a href="https://calendly.com/nacho-coppa/basic-service" className="pointer-events-auto rounded-md bg-indigo-600 py-2 px-3 text-[1.5rem] font-semibold leading-5 text-white hover:bg-indigo-500">Book now!</a>
                        </div>
        ...
        case 'extend':
            return (
                <section id="bottom">
                    ...
                    <div className="inline-flex justify-center items-center w-full">
                        <hr className="my-8 sm:w-64 h-px bg-gray-200 border-0 dark:bg-gray-700" />
                        <h1 className= "text-4xl sm:text-6xl font-bold text-black">Extend my car life service:</h1>
                        <hr className="my-8 sm:w-64 h-px bg-gray-200 border-0 dark:bg-gray-700" />
                    </div>
                    <div className="flex flex-col max-w-[700px] text-black">
                        <p className="text-xl sm:text-2xl font-bold max-w-[700px]">
                    ...
                    <br></br>
                    <div className=" animate-bounce">
                        <a href="https://calendly.com/nacho-coppa/extend-my-life-car" className="pointer-events-auto rounded-md bg-indigo-600 py-2 px-3 text-[1.5rem] font-semibold leading-5 text-white hover:bg-indigo-500">Book now!</a>
                    </div>
                </div>
                </section>
            );
            ...
            return (
                <section id="bottom">
                    ...
                    <div className="inline-flex justify-center align-center items-center w-full">
                        <hr className="my-8 sm:w-64 h-px bg-gray-200 border-0 dark:bg-gray-700" />
                        <h1 className="text-4xl sm:text-6xl font-bold text-black">Pre sell service</h1>
                        <hr className="my-8 sm:w-64 h-px bg-gray-200 border-0 dark:bg-gray-700" />
                    </div>
                    <div className="flex flex-col max-w-[700px] text-black">
                        ...
                        <br></br>
                        <p className="text-xlsm:text-2xl font-bold max-w-[700px]">
                    ...
                    <br></br>
                    <div className=" animate-bounce">
                        <a href="https://calendly.com/nacho-coppa/pre-sell-service" className="pointer-events-auto rounded-md bg-indigo-600 py-2 px-3 text-[1.5rem] font-semibold leading-5 text-white hover:bg-indigo-500">Book now!</a>
                    </div>
                </div>
                </section>
        ...
        case '4wd':
            return (
                <section id="bottom">
                    ...
                    <div className="inline-flex justify-center items-center w-full">
                        <hr className="my-8 sm:w-64 h-px bg-gray-200 border-0 dark:bg-gray-700" />
                        <h1 className="text-4xl sm:text-6xl font-bold text-black">4wd upgrade</h1>
                        <hr className="my-8 sm:w-64 h-px bg-gray-200 border-0 dark:bg-gray-700" />
                    </div>
                    <div className="flex flex-col max-w-[700px] text-black">
                        <p className= "text-xl sm:text-2xl font-bold max-w-[700px]">
                    ...
                    <br></br>
                    <div className=" animate-bounce">
                        <a href="https://calendly.com/nacho-coppa/4wd-upgrade" className="pointer-events-auto rounded-md bg-indigo-600 py-2 px-3 text-[1.5rem] font-semibold leading-5 text-white hover:bg-indigo-500">Book now!</a>
                    </div>
                </div>
                </section>
        ...
        case 'noise':
            return (
                <section id="bottom">
                    ...
                    <div className="inline-flex justify-center items-center w-full">
                        <hr className="my-8 sm:w-64 h-px bg-gray-200 border-0 dark:bg-gray-700" />
                        <h1 className="text-4xl sm:text-6xl font-bold text-black">Whats that noise?</h1>
                        <hr className="my-8 sm:w-64 h-px bg-gray-200 border-0 dark:bg-gray-700" />
                    </div>
                    ...
                    <br></br>
                    <div className=" animate-bounce">
                        <a href="https://calendly.com/nacho-coppa/whats-that-noise" className="pointer-events-auto rounded-md bg-indigo-600 py-2 px-3 text-[1.5rem] font-semibold leading-5 text-white hover:bg-indigo-500">Book now!</a>
                    </div>
                </div>
                </section>
